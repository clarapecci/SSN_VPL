...
def training_loss(ssn_layer_pars, readout_pars, constant_pars, train_data, homeo_data, noise_ref, noise_target, threshold = 0.79):
    ...
    return loss, [all_losses_plot, true_accuracy, sig_input, x, max_rates, thresh_variable]
...
def train_model_homeo(ssn_layer_pars, readout_pars, constant_pars, training_pars, stimuli_pars, single_stimuli_pars, results_filename = None, results_dir = None):
    ...
    for epoch in range(1, training_pars.epochs+1):
        ...
        [epoch_loss, [epoch_all_losses, train_true_acc, train_delta_x, train_x, train_r_ref, _]], grad =loss_and_grad_readout(ssn_layer_pars, readout_pars, constant_pars, train_data, homeo_data, noise_ref, noise_target)
...
#############START TRAINING NEW STAGE ##################################    
    ...
    for epoch in range(1, training_pars.epochs +1):
        ...
        [epoch_loss, [epoch_all_losses, train_true_acc, train_delta_x, train_x, train_r_ref, thresh_variable]], grad =loss_and_grad_ssn(ssn_layer_pars, readout_pars, constant_pars, train_data, homeo_data, noise_ref, noise_target)
        ...
        if epoch in epochs_to_save:
            ...
            [val_loss, [val_all_losses, true_acc, val_delta_x, val_x, _,_]], _= loss_and_grad_ssn(ssn_layer_pars, readout_pars, constant_pars, test_data, homeo_data, noise_ref, noise_target)
            val_time = time.time() - start_time
            print('Training loss: {} ¦ Validation -- loss: {}, true accuracy: {}, at epoch {}, (time {}, {})'.format(epoch_loss, val_loss, true_acc, epoch, epoch_time, val_time))
